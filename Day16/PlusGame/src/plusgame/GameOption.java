...
public class GameOption {
    ...
    public void loadOption(String userId) throws ClassNotFoundException, SQLException {
        ...
        this.numofquestions = Integer.parseInt(dao.getString_DB("SELECT userLevel FROM option WHERE userid="+"'"+ this.userId +"'", "userLevel"));
    }

    public void saveOption() throws ClassNotFoundException, SQLException {
        
        dao.insert_OptionDB(this.userId, this.level, String.valueOf(this.numofquestions));
    }
